...
st.markdown(f"""
    ...
    .day-header {{ text-align: center; background-color: {current_color}; color: #000; padding: 10px; border-radius: 4px; font-weight: bold; margin-bottom: 10px; border: 1px solid rgba(0,0,0,0.1); }}
